        ...
        <div className="flex-1 flex flex-col min-h-0">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {isProUser ? (
                            <Link
                                ...
                                className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-primary-600 border border-transparent rounded-md hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500"
                            >
                                <svg
                            ...
                            <div className="text-right">
                                <Link
                                    ...
                                    className="inline-flex items-center px-4 py-2 text-sm font-medium text-primary-600 bg-primary-100 border border-primary-200 rounded-md hover:bg-primary-100"
                                >
                                    <svg
                                        className="w-4 h-4 mr-2"
                                        fill="none"
                                ...
                                <p className="text-xs text-zinc-500 mt-1">
                                    Team creation requires Pro
                                </p>
                            </div>
                        )}
                    </div>
                    <p className="text-zinc-600 mt-2">
                        Collaborate with your team members on prompts, chains,
                        and categories
                    </p>
                </div>
            </div>
            ...
            <div className="flex-1 overflow-auto p-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center space-x-2 pt-4 border-t border-zinc-100">
                                            <Link
                                                ...
                                                className="flex-1 text-center py-2 px-3 text-sm font-medium text-white bg-primary-600 border border-transparent rounded-md hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500"
                                            >
                                                Open Team
                                            </Link>
                                            ...
                                            {isAdmin && (
                                                <Link
                                                    ...
                                                    className="p-2 text-zinc-400 hover:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-md"
                                                    title="Team Settings"
                                                >
                                                    <svg
                                                        className="w-4 h-4"
                ...
                {!isProUser && teams.length > 0 && (
                    <div className="bg-primary-100 border border-primary-200 rounded-lg p-6 mt-8">
                        <div className="flex items-start">
                            ...
                            <div className="ml-3">
                                ...
                                <div className="mt-2 text-sm text-primary-700">
                                    <p>
                                        Upgrade to Pro to create your own teams,
                                        get unlimited team members, and access
                                ...
                                <div className="mt-4">
                                    <Link
                                        to="/pricing"
                                        className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-primary-700 bg-primary-100 hover:bg-primary-200 focus:outline-none focus:ring-2 focus:ring-primary-500"
                                    >
                                        View Pro Plans
                                    </Link>
                                </div>
