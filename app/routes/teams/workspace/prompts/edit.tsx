...
export default function EditTeamPrompt({ loaderData }: Route.ComponentProps) {
  const { team, promptId } = loaderData;
  
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Edit Team Prompt</h1>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
        ...
        <p className="text-gray-600">
          Team prompt editing will be available in the next update.
        </p>
      </div>
    </div>
  );
