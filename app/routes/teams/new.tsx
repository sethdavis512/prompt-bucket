                    ...
                    <div className="flex items-start">
                        ...
                        <div className="ml-3">
                            ...
                            <div className="mt-2 text-sm text-amber-700">
                                <p>
                                    Team creation is available for Pro
                                    subscribers only. Upgrade to Pro to create
                                    teams and collaborate with your colleagues.
                                </p>
                            </div>
                            <div className="mt-4">
                                <Link
        ...
        <div className="max-w-2xl mx-auto">
            ...
            <Form method="post" className="space-y-6">
                        ...
                        <div className="flex">
                            ...
                            <div className="ml-3">
                                ...
                                {actionData.fieldErrors &&
                                    Object.keys(actionData.fieldErrors).length >
                                        0 && (
                ...
                <div>
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input
                            ...
                            required
                            data-cy="team-slug"
                            className={`flex-1 px-3 py-2 border rounded-r-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 ${
                    ...
                    <p className="mt-1 text-sm text-zinc-500">
                        Choose a unique URL for your team. Use lowercase
                        letters, numbers, and hyphens only.
                    </p>
                </div>

                <div className="bg-primary-100 border border-primary-200 rounded-md p-4">
                    <div className="flex">
                        <div className="flex-shrink-0">
                            <svg
                        ...
                        <div className="ml-3">
                            ...
                            <div className="mt-2 text-sm text-primary-700">
                                <ul className="list-disc list-inside space-y-1">
                                    <li>
                                        You'll be the team admin and can invite
                                        members
                                    </li>
                                    <li>
                                        Team members can create and share
                                        prompts, chains, and categories
                                    </li>
                                    <li>
                                        All team content is private by default
                                    </li>
                                    <li>
                                        You can manage permissions and settings
                                        after creation
                                    </li>
                                </ul>
                            </div>
                ...
                <div className="flex justify-end space-x-3">
                    <Link
                        to="/teams"
                        className="px-4 py-2 text-sm font-medium text-zinc-700 bg-white border border-zinc-300 rounded-md hover:bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-primary-500"
                    >
                        Cancel
                    </Link>
                    <button
