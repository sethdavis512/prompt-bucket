...
const features = [
  {
    ...
    description: "Build prompts using our proven methodology that breaks down complex instructions into organized sections."
  },
  {
    icon: Zap,
    title: "Easy Management",
    description: "Create, edit, organize, and export your prompt templates with our intuitive interface."
  },
  {
    icon: BookOpen,
    title: "Category Organization",
    description: "Organize your prompts by categories like Writing, Code, Business, Education, and more."
  },
  {
    icon: Users,
    title: "Personal Library",
    description: "Build your own curated collection of prompt templates for different use cases and projects."
  }
]

const promptSections = [
  "Task Context", "Tone Context", "Background Data", "Detailed Task Description",
  "Examples", "Conversation History", "Immediate Task", "Thinking Steps",
  "Output Formatting", "Prefilled Response"
]
          ...
          <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Create better AI prompts using our 10-section methodology. 
                Organize, manage, and export your prompt templates for consistent, high-quality results.
              </p>
        ...
        <div className="py-24 bg-white">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Our platform provides all the tools you need to create, organize, and manage 
                professional-quality AI prompts.
              </p>
            </div>
        ...
        <div className="py-24 bg-gray-50">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Structure your prompts using our proven framework that ensures 
                comprehensive, clear, and effective AI instructions.
              </p>
            </div>
            <div className="mx-auto mt-16 max-w-4xl">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-2">
                {promptSections.map((section, index) => (
                  <div key={section} className="flex items-center space-x-3 bg-white p-4 rounded-lg shadow-sm">
          ...
          <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-indigo-200">
                Join thousands of users who are already creating professional-quality 
                AI prompts with our structured approach.
              </p>
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <Link
                  to="/auth/signup"
