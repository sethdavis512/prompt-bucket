                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                {loaderData.isProUser ? (
                                    <select
                                        ...
                                        className="border border-zinc-300 rounded-md px-3 py-2 text-sm focus:ring-primary-500 focus:border-primary-500 bg-white text-zinc-900"
                                    >
                                    ...
                                    <select
                                        disabled
                                        data-cy="category-filter"
                                        className="border border-zinc-300 rounded-md px-3 py-2 text-sm bg-zinc-100 text-zinc-500 cursor-not-allowed"
                                    >
                    ...
                    <div className="bg-white shadow rounded-lg">
                        <div className="text-center py-12">
                            ...
                            <h3 className="mt-2 text-sm font-medium text-zinc-900">
                                {loaderData.search || loaderData.categoryId
